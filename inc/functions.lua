...
─────▀██▀─────
│MiFeA  ‿ @GGGGOQ 
تم تطوير وبرمجة السورس من قبل غيوثي
│ @GGGGOQ  ‿ @GGGGOQ  
#-------------------------------------------------------------------
]]
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(mifea..":NameBot:")
...
var = 'مطور اساسي 👨🏻‍✈️' 
elseif redis:sismember(mifea..':SUDO_BOT:',UserID) then
var = 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(mifea..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي👷🏽' 
elseif redis:sismember(mifea..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء 👷🏽' 
elseif redis:sismember(mifea..'owners:'..ChatID,UserID) then
var = 'مدير البوت 👨🏼‍⚕️' 
elseif redis:sismember(mifea..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت 👨🏼‍🎓' 
elseif redis:sismember(mifea..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
...
if msg.edited then
redis:incr(mifea..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(mifea..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(mifea..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(mifea..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(mifea..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(mifea..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(mifea..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(mifea..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(mifea..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(mifea..':SUDO_BOT:')
message = '👨🏽‍💻*│* قائمه الـمـطـوريـن : \n\n`👨‍✈️│مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*┄─┅══┅─┄ *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n📛 *"
else
for k,v in pairs(list) do
local info = redis:hgetall(mifea..'username:'..v)
local count = redis:scard(mifea..'mtwr_count'..v)
...
local monsha = redis:smembers(mifea..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*┄─┅══┅─┄ \n\n📋│ قائمه المدراء :*\n\n'
local list = redis:smembers(mifea..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(mifea..'admins:'..msg.chat_id_)
...
local list = redis:smembers(mifea..'whitelist:'..msg.chat_id_)
...
if redis:sismember(mifea..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(mifea..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(mifea..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(mifea..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(mifea..'gban_users')
...
local list = redis:smembers(mifea..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(mifea..':Filter_Word:'..msg.chat_id_,word) then 
return  "📝*│*الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع✓️" 
else
redis:sadd(mifea..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(mifea..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(mifea..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(mifea..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(mifea..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(mifea..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(mifea..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(mifea..'group:ids')
message = '📋*│*قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(mifea..'group:name'..v)
if info then 
...
redis:del(
mifea..'group:add'..id_group,
mifea..'lock_link'..id_group, 
mifea..'lock_id'..id_group,
mifea..'lock_spam'..id_group, 
mifea..'lock_webpage'..id_group,
mifea..'lock_markdown'..id_group,
mifea..'lock_flood'..id_group,
mifea..'lock_bots'..id_group,
mifea..'mute_forward'..id_group,
mifea..'mute_contact'..id_group,
mifea..'mute_location'..id_group,
mifea..'mute_document'..id_group,
mifea..'mute_keyboard'..id_group,
mifea..'mute_game'..id_group,
mifea..'mute_inline'..id_group,
mifea..'lock_username'..id_group,
mifea..'num_msg_mifea'..id_group,
mifea..'replay'..id_group
)
redis:srem(mifea..'group:ids',id_group)
end
...
redis:hset(mifea..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(mifea..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(mifea..'group:add'..msg.chat_id_) then  return '🎗*│*المجموعه بالتأكيد ✓️ تم تفعيلها' end
...
redis:setex(mifea..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(mifea..':addnumberusers') or 0)
...
local lock_service = redis:get(mifea..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(mifea..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(mifea..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
mifea..'group:add'..msg.chat_id_,true,
mifea..'lock_link'..msg.chat_id_,true, 
mifea..'lock_id'..msg.chat_id_,true,
mifea..'lock_spam'..msg.chat_id_,true,
mifea..'lock_webpage'..msg.chat_id_,true,
mifea..'lock_markdown'..msg.chat_id_,true,
mifea..'lock_flood'..msg.chat_id_,true,
...
mifea..'mute_keyboard'..msg.chat_id_,true,
mifea..'mute_game'..msg.chat_id_,true,
mifea..'mute_inline'..msg.chat_id_,true,
mifea..'lock_username'..msg.chat_id_,true,
mifea..'num_msg_mifea'..msg.chat_id_,5, 
mifea..'replay'..msg.chat_id_,true
)

redis:sadd(mifea..'group:ids',msg.chat_id_) 
redis:sadd(mifea..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(mifea..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(mifea..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(mifea..'group:add'..msg.chat_id_) then return '🛠*│* المجموعه بالتأكيد ✓️ تم تعطيلها' end  
...
if redis:sismember(mifea..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(mifea..'username:'..UserID,'username',Resolv)
redis:sadd(mifea..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تمت ترقيته ليصبح منشىء في البوت \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(mifea..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(mifea..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(mifea..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(mifea..'username:'..UserID,'username',Resolv)
redis:sadd(mifea..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تمت ترقيته ليصبح منشىء اساسي في البوت \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(mifea..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(mifea..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(mifea..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(mifea..'username:'..UserID, 'username', Resolv)
redis:sadd(mifea..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(mifea..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(mifea..'whitelist:'..ChatID,UserID)
...
if redis:sismember(mifea..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(mifea..'username:'..UserID, 'username', Resolv)
redis:sadd(mifea..'owners:'..ChatID,UserID)
...
if redis:sismember(mifea..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(mifea..'username:'..UserID, 'username', Resolv)
redis:sadd(mifea..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(mifea..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(mifea..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(mifea..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(mifea..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(mifea..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(mifea..'username:'..UserID, 'username', Resolv)
redis:sadd(mifea..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم حظره  \n✓️',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(mifea..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم بالتأكيد الغاء حظره  \n✓️',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم الغاء حظره \n✓️',17,USERCAR) 
end
redis:srem(mifea..'banned:'..ChatID,UserID)
...
if redis:sismember(mifea..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم بالتأكيد كتمه  \n✓️',17,USERCAR) 
end
redis:hset(mifea..'username:'..UserID, 'username', Resolv)
redis:sadd(mifea..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم كتمه \n✓️',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(mifea..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم بالتاكيد الغاء كتمه  \n✓️',17,USERCAR) 
end
redis:srem(mifea..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم الغاء كتمه  \n✓️',17,USERCAR) 
end
...
redis:hset(mifea..'username:'..UserID, 'username',Resolv)
redis:sadd(mifea..'gban_users',UserID)
...
redis:srem(mifea..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم الغاء حظره العام \n✓️',17,USERCAR) 
end
...
if redis:sismember(mifea..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد مطور \n✓️',17,USERCAR) 
end
redis:hset(mifea..'username:'..UserID, 'username', Resolv)
redis:sadd(mifea..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم ترقيته ليصبح مطور \n✓️',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(mifea..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد ليس مطور \n✓️',17,USERCAR) 
end
redis:srem(mifea..':SUDO_BOT:',UserID)
...
redis:hset(mifea..'username:'..UserID, 'username', UserName)
redis:sadd(mifea..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,'🙍🏻‍♂*╿*العضو » ❪ '..UserName..' ❫\n🎟*│*الايدي » ❪ `'..UserID..'` ❫\n💯*╽*تمت ترقيته ليصبح منشىء في البوت \n✓️')
end
...
if redis:sismember(mifea..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'🙍🏻‍♂*╿*العضو » ❪ '..UserName..' ❫\n🎫*│*الايدي » ❪ `'..UserID..'` ❫\n💯*╽*تم بالتأكيد حظره \n✓️') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
Restrict(ChatID,UserID,1)
redis:hset(mifea..'username:'..UserID, 'username', Resolv)
redis:sadd(mifea..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم تقييد آلعضـو بنجآح \n✓️',17,USERCAR) 
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(mifea..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم فگ تقييد آلعضـو بنجآح \n✓️',17,USERCAR) 
end
if cmd == "setwhitelist" then
if redis:sismember(mifea..'whitelist:'..ChatID,UserID) then 
...
if cmd == "dn_sudo" then
if not redis:sismember(mifea..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'🙍🏻‍♂*╿*العضو » '..USERNAME..' \n🎫*│* الايدي » (`'..UserID..'`)\n💯*╽*انه بالتأكيد ليس مطور \n✓') end
redis:srem(mifea..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم تنزيله من المطورين \n✓️',17,USERCAR) 
end
...
if redis:get(mifea..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(mifea..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(mifea..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(mifea..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*👮🏾*` اعدادات المجموعه :` \n"
.."\n📝╿التعديل «» "..(redis:get(mifea..'lock_edit'..msg.chat_id_) or 'false')
.."\n🔗│الروابط «» "..(redis:get(mifea..'lock_link'..msg.chat_id_) or 'false')
.."\n⃣│التاك «» "..(redis:get(mifea..'lock_tag'..msg.chat_id_) or 'false')
.."\n🐞│المعرفات «» "..(redis:get(mifea..'lock_username'..msg.chat_id_) or 'false')
.."\n💱│التكرار «» "..(redis:get(mifea..'lock_flood'..msg.chat_id_) or 'false')
.."\n📑│الكلايش «» "..(redis:get(mifea..'lock_spam'..msg.chat_id_) or 'false')
.."\n🌐│الويب «» "..(redis:get(mifea..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⚜️│الماركدوان «» "..(redis:get(mifea..'lock_markdown'..msg.chat_id_) or 'false')
.."\n🏌🏻│بالطرد البوتات «» "..(redis:get(mifea..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n🤖│البوتات «» "..(redis:get(mifea..'lock_bots'..msg.chat_id_) or 'false')
.."\n➕│عدد التكرار «» "..(redis:get(mifea..'num_msg_mifea'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n🎬│`اعدادات الوسائط :`\n"
.."\n*🎑│*المتحركه «» "..(redis:get(mifea..'mute_gif'..msg.chat_id_) or 'false')
.."\n💭│الدردشه «» "..(redis:get(mifea..'mute_text'..msg.chat_id_) or 'false')
.."\n◽️│الانلاين «» "..(redis:get(mifea..'mute_inline'..msg.chat_id_) or 'false')
.."\n🎮│الالعاب «» "..(redis:get(mifea..'mute_game'..msg.chat_id_) or 'false')
.."\n🏞│الصور «» "..(redis:get(mifea..'mute_photo'..msg.chat_id_) or 'false')
.."\n🎥│الفيديو «» "..(redis:get(mifea..'mute_video'..msg.chat_id_) or 'false')
.."\n🎙│البصمات «» "..(redis:get(mifea..'mute_audio'..msg.chat_id_) or 'false')
.."\n🔉│الصوت «» "..(redis:get(mifea..'mute_voice'..msg.chat_id_) or 'false')
.."\n🎎│الملصقات «» "..(redis:get(mifea..'mute_sticker'..msg.chat_id_) or 'false')
.."\n📞│الجهات «» "..(redis:get(mifea..'mute_contact'..msg.chat_id_) or 'false')
.."\n💱│التوجيه «» "..(redis:get(mifea..'mute_forward'..msg.chat_id_) or 'false')
.."\n🌐│الموقع «» "..(redis:get(mifea..'mute_location'..msg.chat_id_) or 'false')
.."\n🗂│الملفات «» "..(redis:get(mifea..'mute_document'..msg.chat_id_) or 'false')
.."\n🔅│الاشعارات «» "..(redis:get(mifea..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n🔒│الكيبورد «» "..(redis:get(mifea..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⚒│*`اعدادات اخرى : `"
.."\n\n*🙋🏼‍♂️│*الترحيب «» "..welcomex
.."\n*💬│*الردود «» "..replayx
...
.."\n*🌐│*الويب «» "..(redis:get(mifea..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*⚜️│*الماركدوان «» "..(redis:get(mifea..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*🏌🏻│*البوتات بالطرد «» "..(redis:get(mifea..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*🤖│*البوتات «» "..(redis:get(mifea..'lock_bots'..msg.chat_id_) or 'false')
.."\n*➕╽*عدد التكرار «» "..(redis:get(mifea..'num_msg_mifea'..msg.chat_id_) or 'false')
.."\n┄─┅═ـ═┅─┄\n*👨‍💻*اعدادات التقـييد :\n"
.."\n*💢╿*التقييد بالتوجيه «» "..(redis:get(mifea..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*📸│*التقييد بالصور «» "..(redis:get(mifea..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*🔗│*التقييد بالروابط «» "..(redis:get(mifea..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*🎉│*التقييد بالمتحركه «» "..(redis:get(mifea..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*🎥╽*التقييد الفيديو «» "..(redis:get(mifea..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
