...
function lock_pharsi(msg)
    ...
    if redis:get(mifea.."lock_pharsi"..msg.chat_id_) then
    return sendMsg(msg.chat_id_,msg.id_,"تم قفل الفارسيه مسبقأ" ) 
    else
    redis:set(mifea.."lock_pharsi"..msg.chat_id_,true)
    ...
    msg = arg.msg 
    local NameUser   = Hyper_Link_Name(data)
    if not redis:get(mifea.."lock_pharsi"..msg.chat_id_) then
    return sendMsg(msg.chat_id_,msg.id_,"تم فتح الفارسيه بنجاح " ) 
    else 
    redis:del(mifea.."lock_pharsi"..msg.chat_id_)
    return sendMsg(msg.chat_id_,msg.id_," 💥┃ لقد قام 〆 "..NameUser.." \n بفتح الفارسيه بنجاح✅ " ) 
    end
    end,{msg=msg})
    end
    ...
    msg = arg.msg 
    local NameUser   = Hyper_Link_Name(data)
    if redis:get(mifea.."lock_mmno3"..msg.chat_id_) then
    return sendMsg(msg.chat_id_,msg.id_,"💥┃ تم بالتأكيد قفل الفشار    \n💥┃بواسطه ⋙「 "..NameUser.." 」 " ) 
    else
    redis:set(mifea.."lock_mmno3"..msg.chat_id_,true)
    ...
    msg = arg.msg 
    local NameUser   = Hyper_Link_Name(data)
    if not redis:get(mifea.."lock_mmno3"..msg.chat_id_) then
    return sendMsg(msg.chat_id_,msg.id_,"💥┃تم بالتأكيد فتح الفشار    \n💥┃بواسطه ⋙「 "..NameUser.." 」 " ) 
    else 
    redis:del(mifea.."lock_mmno3"..msg.chat_id_)
    ...
    msg = arg.msg 
    local NameUser   = Hyper_Link_Name(data)
    if redis:get(mifea.."lock_edit_media"..msg.chat_id_) then
    return sendMsg(msg.chat_id_,msg.id_,"💥 ┃ تم قفل تعديل الميديا سابقا\n\n💥 ┃ بواسطه ⋙ 「 "..NameUser.." 」 " ) 
    else
    redis:set(mifea.."lock_edit_media"..msg.chat_id_,true)
    ...
    msg = arg.msg 
    local NameUser   = Hyper_Link_Name(data)
    if not redis:get(mifea.."lock_edit_media"..msg.chat_id_) then
    return sendMsg(msg.chat_id_,msg.id_,"💥 ┃ تم فتح تعديل الميديا سابقا\n\n💥 ┃ بواسطه ⋙ 「 "..NameUser.." 」 " ) 
    else 
    redis:del(mifea.."lock_edit_media"..msg.chat_id_)
...
else redis:set(mifea..'lock_woring'..msg.chat_id_,true)
...
if not msg.Admin then return "💥*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if not redis:get(mifea..'lock_woring'..msg.chat_id_) then 
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽*التحذير بالتأكيد معطل\n✓" 
else
redis:del(mifea..'lock_woring'..msg.chat_id_) 
...
if not msg.Admin then return "💥*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if not redis:get(mifea..'lock_id'..msg.chat_id_) then 
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽*الايدي بالتأكيد معطل\n✓" 
else
redis:del(mifea..'lock_id'..msg.chat_id_) 
...
redis:set(mifea..'lock_id'..msg.chat_id_,true)  
...
else redis:set(mifea..'welcome:get'..msg.chat_id_,true)  
...
if not msg.Admin then return "💥*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if not redis:get(mifea..'welcome:get'..msg.chat_id_) then 
...
redis:mset(
mifea..'lock_username'..msg.chat_id_,true,
mifea..'mute_gif'..msg.chat_id_,true,
mifea..'mute_photo'..msg.chat_id_,true,
mifea..'mute_audio'..msg.chat_id_,true,
mifea..'mute_voice'..msg.chat_id_,true,
mifea..'mute_sticker'..msg.chat_id_,true,
mifea..'mute_forward'..msg.chat_id_,true,
mifea..'mute_contact'..msg.chat_id_,true,
mifea..'mute_location'..msg.chat_id_,true,
mifea..'mute_document'..msg.chat_id_,true,
mifea..'lock_link'..msg.chat_id_,true,
mifea..'lock_tag'..msg.chat_id_,true,
mifea..'lock_edit'..msg.chat_id_,true,
mifea..'lock_spam'..msg.chat_id_,true,
mifea..'lock_bots'..msg.chat_id_,true,
mifea..'lock_webpage'..msg.chat_id_,true,
mifea..'mute_video'..msg.chat_id_,true,
mifea..'mute_inline'..msg.chat_id_,true
)
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽*تــ✓ــم قفل الكل  \n✓"
end
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
redis:del(
mifea..'lock_username'..msg.chat_id_,
mifea..'mute_gif'..msg.chat_id_,
mifea..'mute_photo'..msg.chat_id_,
mifea..'mute_audio'..msg.chat_id_,
mifea..'mute_voice'..msg.chat_id_,
mifea..'mute_sticker'..msg.chat_id_,
mifea..'mute_forward'..msg.chat_id_,
mifea..'mute_contact'..msg.chat_id_,
mifea..'mute_location'..msg.chat_id_,
mifea..'mute_document'..msg.chat_id_,
mifea..'lock_link'..msg.chat_id_,
mifea..'lock_tag'..msg.chat_id_,
mifea..'lock_edit'..msg.chat_id_,
mifea..'lock_spam'..msg.chat_id_,
mifea..'lock_bots'..msg.chat_id_,
mifea..'lock_webpage'..msg.chat_id_,
mifea..'mute_video'..msg.chat_id_,
mifea..':tqeed_video:'..msg.chat_id_,
mifea..':tqeed_photo:'..msg.chat_id_,
mifea..':tqeed_gif:'..msg.chat_id_,
mifea..':tqeed_fwd:'..msg.chat_id_,
mifea..':tqeed_link:'..msg.chat_id_,
mifea..'mute_inline'..msg.chat_id_
)
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽*تــ✓ــم فتح الكل  \n✓"
end
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if redis:get(mifea..':tqeed_photo:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد بالصور بالتأكيد تــ✓ــم قفله \n✓'
else
redis:del(mifea..'mute_photo'..msg.chat_id_)
redis:set(mifea..':tqeed_photo:'..msg.chat_id_,true)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(mifea..':tqeed_photo:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد بالصور بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(mifea..':tqeed_photo:'..msg.chat_id_)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if redis:get(mifea..':tqeed_video:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد بالفيديو بالتأكيد تــ✓ــم قفله \n✓'
else
redis:del(mifea..':tqeed_video:'..msg.chat_id_)
redis:set(mifea..':tqeed_video:'..msg.chat_id_,true)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(mifea..':tqeed_video:'..msg.chat_id_) then
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if redis:get(mifea..':tqeed_gif:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد الممتحركه بالتأكيد تــ✓ــم قفله \n✓'
else
redis:del(mifea..'mute_gif'..msg.chat_id_)
redis:set(mifea..':tqeed_gif:'..msg.chat_id_,true)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(mifea..':tqeed_gif:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد المتحركه بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(mifea..':tqeed_gif:'..msg.chat_id_)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if redis:get(mifea..':tqeed_fwd:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد بالتوجيه بالتأكيد تــ✓ــم قفله \n✓'
else
redis:del(mifea..'mute_forward'..msg.chat_id_)
redis:set(mifea..':tqeed_fwd:'..msg.chat_id_,true)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(mifea..':tqeed_fwd:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد التوجيه بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(mifea..':tqeed_fwd:'..msg.chat_id_)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if redis:get(mifea..':tqeed_link:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد بالروابط بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(mifea..':tqeed_link:'..msg.chat_id_,true)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(mifea..':tqeed_link:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد بالروابط بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(mifea..':tqeed_link:'..msg.chat_id_)
...
if redis:get(mifea..'lock_twasel') then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التواصل بالتاكيد تــ✓ــم تعطيله \n✓'
else
redis:set(mifea..'lock_twasel',true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'replay'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الردود بالتاكيد تــ✓ــم تعطيله \n✓'
else
redis:del(mifea..'replay'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(mifea..'replay'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الردود بالتاكيد تــ✓ــم تفعيله \n✓'
else 
redis:set(mifea..'replay'..msg.chat_id_,true)
...
if not msg.SudoBase then return "🚸*│*هذا الامر يخص المطور الاساسي فقط  \n💥" end
if not redis:get(mifea..'lock_service') then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم بالتاكيد تعطيل نظام البوت خدمي \n✓'
else
redis:del(mifea..'lock_service')
...
redis:set(mifea..'lock_service',true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(mifea..'lock_link'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الروابط بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(mifea..'lock_link'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الروابط \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'lock_link'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الروابط بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(mifea..'lock_link'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الروابط \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(mifea..'lock_tag'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التاك (#) بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(mifea..'lock_tag'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل التاك (#) \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'lock_tag'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التاك(#) بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(mifea..'lock_tag'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح التاك (#) \n✓'
end
end
---------------Lock UserName-------------------
...
if redis:get(mifea..'lock_username'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*المعرفات @ بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(mifea..'lock_username'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'lock_username'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*آلمـعرفآت بآلتآگيد تــ✓ــم فتحهآ @ \n✓'
else 
redis:del(mifea..'lock_username'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(mifea..'lock_edit'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التعديل بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(mifea..'lock_edit'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل التعديل \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'lock_edit'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التعديل بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(mifea..'lock_edit'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح التعديل \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if   redis:get(mifea..'lock_spam'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الكلايش بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(mifea..'lock_spam'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الكلايش \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'lock_spam'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الكلايش بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(mifea..'lock_spam'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الكلايش \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(mifea..'lock_flood'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التكرار بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(mifea..'lock_flood'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل التكرار \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'lock_flood'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التكرار بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(mifea..'lock_flood'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح التكرار \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(mifea..'lock_bots'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*البوتات بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(mifea..'lock_bots'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل البوتات \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'lock_bots'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*البوتات بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(mifea..'lock_bots_by_kick'..msg.chat_id_)
redis:del(mifea..'lock_bots'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح البوتات \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(mifea..'lock_join'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الاضافه بالتاكيد تــ✓ــم قفلها \n✓'
else
redis:set(mifea..'lock_join'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الاضافه \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'lock_join'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الاضافه بالتاكيد تــ✓ــم فتحها \n✓'
else 
redis:del(mifea..'lock_join'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الاضافه \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(mifea..'lock_markdown'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الماركدوان بالتاكيد تــ✓ــم قفله \n✓'
else
redis:set(mifea..'lock_markdown'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'lock_markdown'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الماركدوان بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(mifea..'lock_markdown'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(mifea..'lock_webpage'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الويب بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(mifea..'lock_webpage'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الويب \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'lock_webpage'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الويب بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(mifea..'lock_webpage'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الويب \n✓'
end
end
---------------Mute Gif-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(mifea..'mute_gif'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*المتحركه بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(mifea..'mute_gif'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'mute_gif'..msg.chat_id_) then
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(mifea..'mute_game'..msg.chat_id_) then
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'mute_game'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الألعاب بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(mifea..'mute_game'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الألعاب \n✓'
end
end
---------------Mute Inline-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(mifea..'mute_inline'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الانلاين بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(mifea..'mute_inline'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'mute_inline'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الانلاين بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(mifea..'mute_inline'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(mifea..'mute_text'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الدرشه بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(mifea..'mute_text'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الدردشه \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'mute_text'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الدردشه بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(mifea..'mute_text'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الدردشه \n✓'
end
end
---------------Mute photo-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(mifea..'mute_photo'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الصور بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(mifea..'mute_photo'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الصور \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'mute_photo'..msg.chat_id_)then
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(mifea..'mute_video'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الفيديو بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(mifea..'mute_video'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الفيديو \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'mute_video'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الفيديو يال��أكيد تــ✓ــم فتحها \n✓'
else 
redis:del(mifea..'mute_video'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الفيديو \n✓'
end
end
---------------Mute Audio-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(mifea..'mute_audio'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*البصمات بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(mifea..'mute_audio'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل البصمات \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'mute_audio'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*البصمات بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(mifea..'mute_audio'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح البصمات \n✓'
end
end
---------------Mute Voice-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if   redis:get(mifea..'mute_voice'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الصوت بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(mifea..'mute_voice'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الصوت \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'mute_voice'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الصوت بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(mifea..'mute_voice'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الصوت \n✓'
end
end
---------------Mute Sticker-------------------
...
if   redis:get(mifea..'mute_sticker'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الملصقات بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(mifea..'mute_sticker'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'mute_sticker'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الملصقات بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(mifea..'mute_sticker'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(mifea..'mute_contact'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*جهات الاتصال بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(mifea..'mute_contact'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'mute_contact'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*جهات الاتصال بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(mifea..'mute_contact'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(mifea..'mute_forward'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التوجيه بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(mifea..'mute_forward'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل التوجيه \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'mute_forward'..msg.chat_id_) then
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(mifea..'mute_location'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الموقع بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(mifea..'mute_location'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الموقع \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'mute_location'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الموقع بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(mifea..'mute_location'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الموقع \n✓'
end
end
---------------Mute Document-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(mifea..'mute_document'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الملفات بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(mifea..'mute_document'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الملفات \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'mute_document'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الملفات بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(mifea..'mute_document'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الملفات \n✓'
end
end
---------------Mute TgService-------------------
...
redis:set(mifea..'mute_tgservice'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'mute_tgservice'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الاشعارات بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(mifea..'mute_tgservice'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(mifea..'mute_keyboard'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الكيبورد بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(mifea..'mute_keyboard'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'mute_keyboard'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الكيبورد بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(mifea..'mute_keyboard'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(mifea..'lock_bots_by_kick'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*البوتات بالطرد بالتاكيد تــ✓ــم قفله \n✓'
else
redis:set(mifea..'lock_bots'..msg.chat_id_,true)
redis:set(mifea..'lock_bots_by_kick'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'lock_bots_by_kick'..msg.chat_id_) then
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(mifea..'lock_pin'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التثبيت بالفعل مقفل \n✓'
else
redis:set(mifea..'lock_pin'..msg.chat_id_,true) 
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تـم قفل التثبيت \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(mifea..'lock_pin'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التثبيت بالفعل مفتوح \n✓'
else 
redis:del(mifea..'lock_pin'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تـم فتح التثبيت   \n✓'
end
end
